...
# MongoDB setup
mongo_client = pymongo.MongoClient("mongodb+srv://spikemagic:magicspike@cluster0.mdbkg.mongodb.net/TEST?retryWrites=true&w=majority&appName=Cluster0")
...
ADMIN_IDS = {1999446308}  # Replace with your actual admin user ID
...
async def start_attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.answer("Starting the attack...")  # Immediate feedback
    ...
    if process and process.poll() is None:
        await update.callback_query.message.reply_text("Attack is already running. Please stop it before starting a new one.")
        return
...
async def stop_attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    global process
    await update.callback_query.answer("Stopping the attack...")  # Immediate feedback
    ...
    process.terminate()
    process.wait()
    await update.callback_query.message.reply_text("🛑 Attack stopped successfully.")
...
def main():
    ...
    TOKEN = "7340153147:AAGXqSOLm-jgvFIN5wHlXcekXSy4H4sr39g"
